...
QString runText = 
  pfmLoadM::tr ("Pressing this button will begin the PFM loading process.");

QString saveText = 
  pfmLoadM::tr ("Pressing this button will allow you to save the parameters that you have input to this wizard to "
               ...
               "command line for pfmLoadM or pfmLoadMer, or an <b>update</b> parameter file (.upr) that can only be "
               "used as a command line argument to pfmLoadMer.  The normal parameter file (.prm) may be used in a "
               "subsequent run of pfmLoadM/pfmLoadMer, as a template for another area, or to rebuild the same area "
               ...
               "collected data.  The scenario would go something like this;  you run pfmLoadM on the first day of the "
               ...
               "<b>Cancel</b> and run pfmLoadMer with the .upr file name on the command line.  On subsequent days all "
               "you have to do is run pfmLoadMer with the .upr file name on the command line in order to add all "
