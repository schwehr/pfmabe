...
void Do_PFM_Processing (NV_INT32 beam, NV_FLOAT64 depth, NV_F64_COORD2 nxy, NV_U_INT32 flags, NV_FLOAT64 heading,
                        NV_BOOL force, NV_FLOAT32 *l_attr, PFM_LOAD_PARAMETERS load_parms[], 
                        PFM_DEFINITION pfm_def[], NV_INT32 percent);
