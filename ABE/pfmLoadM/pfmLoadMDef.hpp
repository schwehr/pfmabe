...
#ifndef __PFMLOADMDEF_H__
#define __PFMLOADMDEF_H__
...
{
  NV_INT32            pos;
  DEPTH_RECORD        rec[BUFFER_SIZE];
} TRANSFER;

typedef struct
{
  NV_F64_XYMBR        mbr[CONSUMERS];
  NV_INT32            hnd[CONSUMERS];
  //NV_I32_COORD2       corners[4][CONSUMERS];
} THREAD_DATA;
