QString prefsText = 
  hawkeyeMonitor::tr ("<img source=\":/icons/prefs.xpm\"> Click this button to change program preferences.  This includes "
                       "position format and the colors.");
QString IRText = 
  hawkeyeMonitor::tr ("<img source=\":/icons/mode_line.xpm\"> <img source=\":/icons/mode_dot.xpm\"> Click this button to toggle between line and dot drawing "
                       "modes for the wave display.  When selected the waves are drawn as lines, when unselected the waves are drawn "
                       "as unconnected dots.");

QString quitText = 
  hawkeyeMonitor::tr ("<img source=\":/icons/quit.xpm\"> Click this button to <b><em>exit</em></b> from the program.  "
                       "You can also use the <b>Quit</b> entry in the <b>File</b> menu.");
QString mapText = 
  hawkeyeMonitor::tr ("This is the hawkeyeMonitor program, a companion to the pfmEdit program for viewing Charts "
                       "LIDAR HOF hawkeyes.  There are a number of action keys that may be pressed while in the "
                       "pfmEdit window.  The default actions and key values are :<br><br>"
                       "Swap primary and secondary depth - s<br>"
                       "Toggle display of APD hawkeye - 1<br>"
                       "Toggle display of PMT hawkeye - 2<br>"
                       "Toggle display of IR hawkeye - 3<br>"
                       "Toggle display of RAMAN hawkeye - 4<br><br>"
                       "The actual key values may be changed in pfmEdit using the Preferences->Ancillary Programs "
                       "dialog.  Help is available on all fields in hawkeyeMonitor using the What's This pointer.");

QString bGrpText = 
  hawkeyeMonitor::tr ("Select the format in which you want all geographic positions to be displayed.");

QString closePrefsText = 
  hawkeyeMonitor::tr ("Click this button to close the preferences dialog.");

QString restoreDefaultsText = 
  hawkeyeMonitor::tr ("Click this button to restore colors, size, and position format to the default settings.");

QString shallowText = 
  hawkeyeMonitor::tr ("This is the name of the input file from which this point was taken");

QString deepText = 
  hawkeyeMonitor::tr ("This is the date and time of the point.  The fields are, in order, year, month, day, "
                       "(julian day), hour, minutes, and second.");

QString shotText = 
  hawkeyeMonitor::tr ("This is the record number in the input file of this point");

QString dataTypeText = 
  hawkeyeMonitor::tr ("This will either be DGPS or KGPS for differential or kinematic respectively.");

QString correctDepthText = 
  hawkeyeMonitor::tr ("This is the final depth after tide (DGPS) or datum (KGPS) corrections.  Note that these "
                       "corrections may not have been made yet.  Check the tide/datum field.");

QString secDepthText = 
  hawkeyeMonitor::tr ("This is the secondary corrected depth (if available).  Check the tide/datum field to see "
                       "if tide/datum corrections have been applied.");

QString reportedDepthText = 
  hawkeyeMonitor::tr ("This is the depth without the tide/datum correction.  This can come from either the "
...
QString tideLabelText = 
  hawkeyeMonitor::tr ("This is the tide correction if in DGPS mode or the datum correction if in KGPS mode.  This "
                       "may be 0.0.");

QString waveHeightText = 
  hawkeyeMonitor::tr ("This is the estimated wave height.");

QString abdcLabelText = 
  hawkeyeMonitor::tr ("This is the abbreviated depth confidence.  It is either from ab_dep_conf or kgps_abd_conf "
...
QString sabdcLabelText = 
  hawkeyeMonitor::tr ("This is the secondary abbreviated depth confidence.  It is either from sec_ab_dep_conf or "
...
QString botBinLabelText = 
  hawkeyeMonitor::tr ("This is the bottom channel and bin used to derive the depth.  The channel will either be "
...
QString secBotBinLabelText = 
  hawkeyeMonitor::tr ("This is the bottom channel and bin used to derive the secondary depth.  The channel will "
...
QString sfcBinLabelText = 
  hawkeyeMonitor::tr ("This is the surface channel and bin used to derive the secondary depth.  The channel will "
...
QString fullConfText = 
  hawkeyeMonitor::tr ("Full depth confidence or GG Conf.  Each digit of the full depth confidence is used for "
...
QString secFullConfText = 
  hawkeyeMonitor::tr ("Secondary full depth confidence or GG Conf.  Each digit of the full depth confidence is used for "
                       "specific information:<br><br>"
                       "digit 1 - State index (2-4) else (7-9) if killer flag is set<br>"
                       "digit 2 - Mode index (0-3) else (5-8) if BFOM is less than the bottom threshold<br>"
                       "digit 3 - Surface channel used (0-3) else (5-8) if non-killer flag is set<br>"
...
QString bfomThreshText = 
  hawkeyeMonitor::tr ("Bottom figure of merit threshold times 10.  This value (unitless) is the threshold for "
...
QString secBfomThreshText = 
  hawkeyeMonitor::tr ("Secondary bottom figure of merit threshold times 10.  This value (unitless) is the threshold for "
...
QString sigStrengthText = 
  hawkeyeMonitor::tr ("Bottom signal strength.  Waiting for more info from Jeff Croucher (Fugro)");

QString secSigStrengthText = 
  hawkeyeMonitor::tr ("Secondary bottom signal strength.  Waiting for more info from Jeff Croucher (AKA "
                       "Crouching Gerbil)");


QString haps_versionText = 
  hawkeyeMonitor::tr ("HAPS version.  Waiting for more info from Jeff Croucher (Fugro)");

QString position_confText = 
  hawkeyeMonitor::tr ("Position confidence.  Waiting for more info from Jeff Croucher (Fugro)");

QString suggested_dksText = 
  hawkeyeMonitor::tr ("Suggested <b><i>Delete, Kept, Swapped</i></b> flag.  Waiting for more info from Jeff "
                       "Croucher (Fugro)");

QString suspect_statusText = 
  hawkeyeMonitor::tr ("Suspect <b><i>Delete, Kept, Swapped</i></b> flag.  Waiting for more info from Jeff "
                       "Croucher (Fugro)");

QString tide_statusText = 
  hawkeyeMonitor::tr ("This will either be <b><i>Predicted</i></b>, <b><i>Observed</i></b>, "
                       "<b><i>Verified</i></b>, or (if in KGPS mode) <b><i>N/A</i></b>");

QString topoText = 
  hawkeyeMonitor::tr ("Waiting for more info from Jeff Croucher (Fugro)");

QString latitudeText = 
  hawkeyeMonitor::tr ("Latitude of the point.");

QString longitudeText = 
  hawkeyeMonitor::tr ("Longitude of the point.");

QString sec_latitudeText = 
  hawkeyeMonitor::tr ("Latitude of the secondary point, if available.");

QString sec_longitudeText = 
  hawkeyeMonitor::tr ("Longitude of the secondary point, if available.");

QString altitudeText = 
  hawkeyeMonitor::tr ("Aircraft altitude.");

QString kgps_water_levelText = 
  hawkeyeMonitor::tr ("Waiting for more info from Jeff Croucher (Fugro)");

QString nadir_angleText = 
  hawkeyeMonitor::tr ("This is the angle of the laser off nadir.  This should be very close to 20 degrees.");

QString scanner_azimuthText = 
  hawkeyeMonitor::tr ("This is the laser scanner angle.  It will sweep from approximately -60 degrees on the "
                       "left side to +60 degrees on the right.");

QString sfc_fom_apdText = 
  hawkeyeMonitor::tr ("Surface signal strength for the APD channel.  Waiting for more info from Jeff Croucher "
                       "(Fugro)");

QString sfc_fom_irText = 
  hawkeyeMonitor::tr ("Surface signal strength for the IR channel.  Waiting for more info from Jeff Croucher "
                       "(Fugro)");

QString sfc_fom_ramText = 
  hawkeyeMonitor::tr ("Surface signal strength for the RAMAN channel.  Waiting for more info from Jeff Croucher "
                       "(Fugro)");

QString warningsText = 
  hawkeyeMonitor::tr ("Coded bit warnings.  Waiting for more info from Jeff Croucher (Fugro)");
...
QString calc_bot_run0Text = 
  hawkeyeMonitor::tr ("Calculated HAP for primary.  Waiting for more info from Jeff Croucher (AKA Crouching Gerbil)");

QString calc_bot_run1Text = 
  hawkeyeMonitor::tr ("Calculated HAP for secondary.  Waiting for more info from Jeff Croucher (AKA Crouching Gerbil)");

QString primary_runText = 
  hawkeyeMonitor::tr ("Run length of the primary run using a minimum run length of 6.  This run length is not based on the same  "
...
QString primary_slopeText = 
  hawkeyeMonitor::tr ("Pseudo-slope value for the primary run.  Since the units used in the rise over run calculation are not the same "
...
QString primary_backslopeText = 
  hawkeyeMonitor::tr ("Pseudo-slope value of the falling side of the run for the primary run.  Since the units used in the rise over run "
...
QString secondary_runText = 
  hawkeyeMonitor::tr ("Run length of the secondary run using a minimum run length of 6.  This run length is not based on the same  "
                       "algorithms that Optech uses.  We do not count 0 rise as a run point.  We also don't vary the minimum run "
                       "length.  Because of this we may not detect some runs that GCS does.  This value is mainly used for checking "
                       "settings for the charts_swap smart swap option.");

QString secondary_slopeText = 
  hawkeyeMonitor::tr ("Pseudo-slope value for the secondary run.  Since the units used in the rise over run calculation are not the same "
                       "this is not a real slope value.  Empirically we have found that a pseudo-slope of 1.0 or greater is significant.  "
...
QString secondary_backslopeText = 
  hawkeyeMonitor::tr ("Pseudo-slope value of the falling side of the run for the secondary run.  Since the units used in the rise over run "
                       "calculation are not the same this is not a real slope value.  Empirically we have found that a pseudo-slope of 1.0 "
...
QString acknowledgementsText = 
  hawkeyeMonitor::tr ("<center><br>hawkeyeMonitor was built using some of the following Open Source libraries:"
                       "<br><br></center>"
                       "<ul>"
