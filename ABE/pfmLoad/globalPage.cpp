      ...
      if (pfm_global->attribute_count >= NUM_ATTR)
        {
          ...
          QMessageBox::warning (this, tr ("pfmLoad Time Attribute"), tr ("Only ten index attributes are allowed"));
        }
      else
        {
      ...
      if (pfm_global->attribute_count >= NUM_ATTR)
        {
          ...
          QMessageBox::warning (global_dialog->gsfD, tr ("pfmLoad GSF Attributes"), tr ("Only ten index attributes are allowed"));
        }
      else
        {
          //  Increment the attribute count and set the attribute number for this attribute.
      ...
      if (pfm_global->attribute_count >= NUM_ATTR)
        {
          ...
          QMessageBox::warning (global_dialog->hofD, tr ("pfmLoad HOF Attributes"), tr ("Only ten index attributes are allowed"));
        }
      else
        {
          //  Increment the attribute count and set the attribute number for this attribute.
      ...
      if (pfm_global->attribute_count >= NUM_ATTR)
        {
          ...
          QMessageBox::warning (global_dialog->tofD, tr ("pfmLoad TOF Attributes"), tr ("Only ten index attributes are allowed"));
        }
      else
        {
          //  Increment the attribute count and set the attribute number for this attribute.
...
globalPage::slotWLFClicked ()
{
  ...
  global_dialog->wlfD->setWindowTitle (tr ("pfmLoad WLF Attributes"));
      ...
      if (pfm_global->attribute_count >= NUM_ATTR)
        {
          ...
          QMessageBox::warning (global_dialog->wlfD, tr ("pfmLoad WLF Attributes"), tr ("Only ten index attributes are allowed"));
        }
      else
        {
          //  Increment the attribute count and set the attribute number for this attribute.
      ...
      if (pfm_global->attribute_count >= NUM_ATTR)
        {
          ...
          QMessageBox::warning (global_dialog->czmilD, tr ("pfmLoad CZMIL Attributes"), tr ("Only ten index attributes are allowed"));
        }
      else
        {
          //  Increment the attribute count and set the attribute number for this attribute.
      ...
      if (pfm_global->attribute_count >= NUM_ATTR)
        {
          ...
          QMessageBox::warning (global_dialog->bagD, tr ("pfmLoad BAG Attributes"), tr ("Only ten index attributes are allowed"));
        }
      else
        {
          //  Increment the attribute count and set the attribute number for this attribute.
...
globalPage::slotHAWKEYEClicked ()
{
  ...
  global_dialog->hawkeyeD->setWindowTitle (tr ("pfmLoad HAWKEYE Attributes"));
      ...
      if (pfm_global->attribute_count >= NUM_ATTR)
        {
          ...
          QMessageBox::warning (global_dialog->hawkeyeD, tr ("pfmLoad HAWKEYE Attributes"), tr ("Only ten index attributes are allowed"));
        }
      else
        {
          //  Increment the attribute count and set the attribute number for this attribute.
...
globalPage::cubeDialog ()
{
  ...
  global_dialog->cubeD->setWindowTitle (tr ("pfmLoad CUBE Options"));
