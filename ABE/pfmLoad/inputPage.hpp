...
public:
  ...
  inputPage (QWidget *parent = 0, QString *inFilt = NULL, QTextEdit **infiles = NULL, PFM_GLOBAL *pfmg = NULL);
...
protected:
  ...
  QPushButton      *inputBrowse, *dirBrowse, *pfmBrowse;
