...
//  To add to these you must change the ???_ATTRIBUTES definitions in pfmLoaderDef.hpp.  Names must not exceed
...
NV_FLOAT32 gsf_attribute_def[GSF_ATTRIBUTES][3] = 
  {{0.0, 360.0, 100.0}, {-30.0, 30.0, 100.0}, {-50.0, 50.0, 100.0}, {-25.0, 25.0, 100.0},
   ...
   {-180.0, 180.0, 100.0}, {-200.0, 200.0, 100.0}, {-200.0, 200.0, 100.0}, {-200.0, 200.0, 100.0}, {0.0, 255.0, 1.0},
