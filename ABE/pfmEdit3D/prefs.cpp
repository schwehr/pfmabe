  ...
  QDialog (parent, (Qt::WindowFlags) Qt::WA_DeleteOnClose)
{
  ...
  cboxRightLayout->addWidget (bScaleColor);
  ...
  conBoxLeftLayout->addWidget (widBox);
  ...
  QGroupBox *psBox = new QGroupBox (tr ("Point style"), this);
  QHBoxLayout *psBoxLayout = new QHBoxLayout;
  psBox->setLayout (psBoxLayout);
  pointStyle = new QComboBox (psBox);
  pointStyle->setToolTip (tr ("Select the point display style"));
  pointStyle->setWhatsThis (pointStyleText);
  pointStyle->setEditable (FALSE);
  pointStyle->addItem (tr ("Points"));
  pointStyle->addItem (tr ("Cubes"));
  pointStyle->addItem (tr ("Pyramids"));
  pointStyle->addItem (tr ("Spheres"));
  pointStyle->addItem (tr ("Diamonds"));
  psBoxLayout->addWidget (pointStyle);
  conBoxRightLayout->addWidget (psBox);


  QGroupBox *owBox = new QGroupBox (tr ("Object Width"), this);
  QHBoxLayout * owBoxLayout = new QHBoxLayout;
  owBox->setLayout (owBoxLayout);

  objectWidthSpinBox = new QDoubleSpinBox (owBox);
  objectWidthSpinBox->setDecimals (4);
  objectWidthSpinBox->setRange (0.0001, 5.0);
  objectWidthSpinBox->setSingleStep (0.001);
  objectWidthSpinBox->setToolTip (tr ("Change the width of the object (see Point style)"));
  objectWidthSpinBox->setWhatsThis (objWidthText);
  owBoxLayout->addWidget (objectWidthSpinBox);
  conBoxRightLayout->addWidget (owBox);


  QGroupBox *dvBox = new QGroupBox (tr ("Divisionals"), this);
  QHBoxLayout *dvBoxLayout = new QHBoxLayout;
  dvBox->setLayout (dvBoxLayout);

  divisional = new QSpinBox (dvBox);
  divisional->setRange (4, 128);
  divisional->setSingleStep (1);
  divisional->setToolTip (tr ("Controls the fineness of the surface"));
  divisional->setWhatsThis (divisionalText);
  dvBoxLayout->addWidget (divisional);
  conBoxRightLayout->addWidget (dvBox);
...
Prefs::slotTrackerColor ()
{
  ...
  clr = QColorDialog::getColor (mod_options.tracker_color, this, tr ("pfmEdit3D Tracker Color"),
...
Prefs::slotEditColor ()
{
  ...
  clr = QColorDialog::getColor (mod_options.edit_color, this, tr ("pfmEdit3D Edit Color"),
                                QColorDialog::ShowAlphaChannel);
...
Prefs::slotMarkerColor ()
{
  ...
  clr = QColorDialog::getColor (mod_options.marker_color, this, tr ("pfmEdit3D Marker Color"),
                                QColorDialog::ShowAlphaChannel);
...
Prefs::slotBackgroundColor ()
{
  ...
  clr = QColorDialog::getColor (mod_options.background_color, this, tr ("pfmEdit3D Background Color"),
                                QColorDialog::ShowAlphaChannel);
...
Prefs::slotRefColor ()
{
  ...
  clr = QColorDialog::getColor (mod_options.ref_color[0], this, tr ("pfmEdit3D Reference Color"),
                                QColorDialog::ShowAlphaChannel);
...
Prefs::slotFeatureColor ()
{
  ...
  clr = QColorDialog::getColor (mod_options.feature_color, this, tr ("pfmEdit3D Feature Color"),
                                QColorDialog::ShowAlphaChannel);
...
Prefs::slotFeatureInfoColor ()
{
  ...
  clr = QColorDialog::getColor (mod_options.feature_info_color, this, tr ("pfmEdit3D Feature Information Color"),
                                QColorDialog::ShowAlphaChannel);
...
Prefs::slotScaleColor ()
{
  ...
  clr = QColorDialog::getColor (mod_options.scale_color, this, tr ("pfmEdit3D Scale Color"),
                                QColorDialog::ShowAlphaChannel);
...
Prefs::slotColorClicked (int id)
{
  ...
  clr = QColorDialog::getColor (mod_options.waveColor[id], this, tr ("pfmEdit3D ") + name + tr (" Color"),
                                QColorDialog::ShowAlphaChannel);
...
Prefs::setFields ()
{
  ...
  pointStyle->setCurrentIndex (mod_options.drawingMode);
  objectWidthSpinBox->setValue (mod_options.objectWidth);
  divisional->setValue (mod_options.objectDivisionals);
...
Prefs::slotApplyPrefs ()
{
  ...
  mod_options.drawingMode = pointStyle->currentIndex ();
  if (mod_options.drawingMode != options->drawingMode) dataChanged = NVTrue;
  mod_options.objectWidth = objectWidthSpinBox->value();
  if (mod_options.objectWidth != options->objectWidth) dataChanged = NVTrue;
  mod_options.objectDivisionals = divisional->value();
  if (mod_options.objectDivisionals != options->objectDivisionals) dataChanged = NVTrue;
