...
QString pointStyleText =
  Prefs::tr ("Select the look and feel of the representation of the data points within the 3D editor");

QString objWidthText =
  Prefs::tr ("The object width spinner applies only to object shapes.  This does not include points.  The " 
             "number indicates the diameter of the shape");

QString divisionalText = 
  Prefs::tr ("The divisional box represents the number of divisions used for each object shape (spheres especially).  The higher the number "
             "the greater the resolution.  Remember, this comes at a price though since it increases polygons "
             "substantially.");
