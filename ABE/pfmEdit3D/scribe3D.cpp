...
/*!
  This is a 3D version of the ever popular scribe contour drawing package.  This will actually draw contours on the
  3D point cloud but it appears to have limited use.  For now, it's commented out in the pfmEdit3D.cpp.
*/
