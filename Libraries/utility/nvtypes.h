...
/* The following definitions should be made at the command line:
   NVWIN3X, NVLinux, NVHP-UX, NVIRIX, NVCLIX, NVSUNOS */

#ifndef __UTILITY_NVTYPES__
#define __UTILITY_NVTYPES__
...
/*  Don't want to collide with pfm_nvtypes.h.  Extra stuff will be included after the #endif  */
...
/*  Things that aren't (yet) defined in pfm_nvtypes.h.  */
    ...
    typedef struct
    {
        ...
        NV_FLOAT64      nlat;
        NV_FLOAT64      elon;
        NV_FLOAT64      min_depth;
        NV_FLOAT64      max_depth;
    } NV_F64_MBC;
