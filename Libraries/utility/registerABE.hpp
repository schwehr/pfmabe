...
public:
  ...
  registerABE (QWidget *parent = 0, const NV_CHAR *name = NULL, NV_INT32 key = 0, const NV_CHAR *file = NULL, 
...
signals:
  ...
  void keySetSignal (NV_INT32 key);


protected:


  NV_INT32        selected, member_id, available_group[MAX_ABE_GROUPS];

  NV_CHAR         member_name[30], member_file[512];
