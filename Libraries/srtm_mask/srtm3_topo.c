...
/***************************************************************************\
*                                                                           *
*   Module Name:        srtm3_topo                                          *
*                                                                           *
*   Programmer(s):      Jan C. Depner                                       *
*                                                                           *
*   Date Written:       October 2006                                        *
*                                                                           *
*   Purpose:            Reads the uncompressed SRTM3 files (*.hgt) and      *
...
*                       directly above the hgt directories (Africa,         *
*                       Australia, Eurasia, etc).  There must be an srtm3   *
*                       directory in the directory pointed to by the        *
*                       SRTM_DATA environment variable.                     *
*                                                                           *
\***************************************************************************/
