...
NV_INT32 read_dted_data (FILE *fp, NV_INT32 count, NV_INT32 block, DTED_DATA *dted_data);
NV_INT32 write_dted_data (FILE *fp, NV_INT32 count, NV_INT32 block, DTED_DATA dted_data);
