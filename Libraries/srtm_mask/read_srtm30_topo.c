...
static NV_U_BYTE         *map;



/***************************************************************************\
*                                                                           *
*   Module Name:        check_srtm30_topo                                   *
*                                                                           *
...
NV_BOOL check_srtm30_topo ()
{
  ...
  sprintf (file, "%s%1csrtm30%1csrtm30_block_map.dat", dir, SEPARATOR, SEPARATOR);
...
/***************************************************************************\
*                                                                           *
*   Module Name:        read_srtm30_topo_one_degree                         *
*                                                                           *
*   Programmer(s):      Jan C. Depner                                       *
*                                                                           *
...
*                       120 (width/height of array, it's square).           *
*                                                                           *
...
*                       if (lon < 0) lon--;                                 *
*                                                                           *
*                       size = read_srtm30_topo_one_degree (lat, lon,       *
*                           &array);                                        *
*                                                                           *
...
*                                                                           *
*                                                                           *
*                       You should also call cleanup_srtm30_topo after you  *
...
NV_INT32 read_srtm30_topo_one_degree (NV_INT32 lat, NV_INT32 lon, NV_INT16 **array)
{
  ...
  NV_INT32               i, j, shift_lat, shift_lon, resolution, pos, size = 0, status, ndx;
  NV_INT64               address;
  uLong                  csize;
  uLongf                 bsize;
  ...
  if (first)
    {
      ...
      sprintf (file, "%s%1csrtm30%1csrtm30_topo.cte", dir, SEPARATOR, SEPARATOR);
  ...
  if (prev_lat != shift_lat || prev_lon != shift_lon)
    {
      ...
      if (bit_box == NULL)
        {
          perror ("Allocating bit_box memory in read_srtm30_topo");
          exit (-1);
        }
      ...
      if (box == NULL)
        {
          perror ("Allocating box memory in read_srtm30_topo");
          exit (-1);
        }
...
*                                                                           *
*   Returns:            0 = water, -32768 undefined, or elevation           *
*                                                                           *
\***************************************************************************/


NV_INT16 read_srtm30_topo (NV_FLOAT64 lat, NV_FLOAT64 lon)
{
  ...
  if (ilat != prev_ilat || ilon != prev_ilon) 
    {
      ...
      size = read_srtm30_topo_one_degree (ilat, ilon, &array);
...
/***************************************************************************\
*                                                                           *
*   Module Name:        cleanup_srtm30_topo                                 *
*                                                                           *
*   Programmer(s):      Jan C. Depner                                       *
*                                                                           *
*   Date Written:       October 2006                                        *
*                                                                           *
*   Purpose:            Closes the open srtm30 topo file, frees memory, and *
