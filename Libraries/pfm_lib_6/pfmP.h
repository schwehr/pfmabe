...
static NV_INT32 pack_bin_record (NV_INT32 hnd, NV_U_BYTE *bin_data, BIN_RECORD *bin, BIN_RECORD_OFFSETS *offsets,
                                 BIN_HEADER_DATA *hd, NV_INT16 list_file_ver, CHAIN *depth_chain);
